package br.com.myself.presentation.adapter
    ...
    companion object {
        private object COMPARATOR : DiffUtil.ItemCallback<UIModelState>()  {
            override fun areItemsTheSame(oldItem: UIModelState, newItem: UIModelState): Boolean {
                return (oldItem is UIModelState.UIEntradaState && newItem is UIModelState.UIEntradaState && oldItem.entrada.id == newItem.entrada.id)
